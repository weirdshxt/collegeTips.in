...
import { BTSImages, chillImages } from "../assets/imageArrays";
...
const BTS = () => {
  ...
  return (
    <div className="main min-h-screen bg-[#faede2] flex items-center justify-center relative">
      ...
      <h1
        id="title-text"
        className="text-4xl sm:text-9xl split absolute z-51 font-bold text-white"
      >
        Behind-the-Scene
      </h1>
      <h1 className="text-4xl sm:text-9xl saviText absolute top-[17%] font-bold">
        Behind-the-Scene
      </h1>
